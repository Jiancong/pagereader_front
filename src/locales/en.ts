...
export default {
  ...
  landing: {
    ...
    tabTranslate: "Immersive translate",
    tabRead: "Read online",
    readTitle: "Read online",
    readHint: "Upload a PDF / EPUB / MOBI ebook and read it right in your browser—no download or install needed.",
    readPickFile: "Choose or drop an ebook file",
    readFormats: "Supports PDF, EPUB, MOBI, XLSX",
    readStart: "Start reading",
    translateTitle: "Immersive translation",
    translateHint: "Upload a PDF or enter a page URL, then read the original and translation side by side. Only what's needed is translated and cached locally.",
    translatePickPdf: "Choose or drop a PDF file",
    translateFormats: "PDF only",
    translateModePdf: "PDF file",
    translateModeUrl: "Web page",
    translateUrlLabel: "Page URL",
    translateUrlPlaceholder: "https://paulgraham.com/ds.html",
    translateUrlHint: "Fetch a public page and show the translation with the same structure on the right.",
    translateStart: "Start immersive translation",
    ...
    uploadFormats: "PDF, Word, TXT, Markdown, EPUB, MOBI, SRT",
    ...
    uploadHint: "PDF, Word, TXT, EPUB, MOBI, SRT, etc.—AI extracts key content for your deck",
    pickFile: "Choose file",
    uploadFormatsShort: "PDF, Word, TXT, Markdown, EPUB, MOBI, SRT",
  ...
  pricing: {
    ...
    usageCardDesc:
      "Distill key ideas into explanatory cards that make content easier to grasp. Daily free credits are used first, then package credits.",
    packsTitle: "Plans",
  ...
  auth: {
    ...
    forgotSubtitle: "Enter your registered email and we will send a 6-digit code",
    forgotResetSubtitle: "Enter the 6-digit code from your email and choose a new password",
    forgotCodePlaceholder: "6-digit code",
    forgotCodeHint: "The email subject is Login with your temporary password; the body contains a 6-digit code",
    ...
    forgotResendIn: "Resend in {seconds}s",
    ...
    forgotCodeSent: "Verification code sent. Check your inbox.",
    forgotFillAll: "Please enter the code and new password",
    forgotPasswordMismatch: "Passwords do not match",
    forgotResetSuccess: "Password reset. Log in with your new password.",
  ...
  workspace: {
    ...
    exploreTopicAll: "All",
    exploreTopicAi: "AI",
    exploreTopicFiction: "Fiction",
    exploreTopicEducation: "Education",
    exploreTopicFinance: "Finance",
    ...
    translateUrlHint: "Fetch a public page and show the translation with the same structure on the right.",
    translateStart: "Start immersive translation",
    translateFromCloud: "Or switch to this tab first, then pick a PDF from the cloud library on the left.",
    translateFetchingPdf: "Loading PDF…",
    translateFetchFailed: "Failed to load PDF. Check your network or upload again.",
    ...
    uploadHintCard:
      "PDF, Word, TXT, EPUB, MOBI, SRT, etc.—AI distills core ideas into easy-to-review knowledge cards",
    uploadHintNovel:
      "PDF, Word, TXT, EPUB, MOBI, SRT, etc.—AI generates a Markdown guide with summary, speakers/characters, chapter notes, and Q&A",
    pickFile: "Choose file",
    uploadFormatsShort: "PDF, Word, TXT, Markdown, EPUB, MOBI, SRT",
    ...
    uploadPromptDefaultSrt:
      "From this interview/podcast transcript, distill key ideas and quotes into a 12-slide share deck—group by topic and note main speakers…",
    uploadPromptDefaultSrtCard:
      "From this interview/podcast transcript, distill key ideas, debates, and actionable takeaways into review cards—preserve each speaker's perspective…",
    ...
    uploadUnsupportedType: "Unsupported file type. Please upload PDF, Word, TXT, Markdown, EPUB, MOBI, or SRT.",
    uploadTooLarge: "File is too large. Please upload a document under 50 MB.",
    srtPreviewTitle: "Transcript preview",
    srtPreviewMeta: "{cues} cues · {speakers} speakers · {chars} chars",
    srtParseEmpty: "No valid subtitle content found in this SRT file. Please check the file format.",
    srtParseFailed: "Failed to read the SRT file. Please try again or choose another file.",
    youtubeTitle: "Generate a deck from YouTube",
    youtubeTitleNovel: "Generate a reading guide from YouTube",
    youtubeTitleOutline: "Organize a transcript outline from YouTube",
    youtubeHint: "Paste a video URL, preview the transcript, then generate your presentation.",
    youtubeHintNovel: "Paste a video URL, preview the transcript, then generate a Markdown reading guide.",
    youtubeHintOutline: "Paste a video URL to organize the full transcript into a semantic Markdown outline (not a summary).",
    youtubeUrlLabel: "YouTube URL",
    youtubeUrlPlaceholder: "https://www.youtube.com/watch?v=...",
    youtubePromptLabel: "Generation prompt",
    youtubePromptHint: "Describe slide count, focus areas, and style.",
    youtubePromptDefault: "Create a ~20-slide deck summarizing this video with the key ideas and conclusions.",
    youtubePromptDefaultNovel: "Generate a Markdown reading guide from this video, including an overall summary, character relationships, chapter-by-chapter notes, and Q&A.",
    youtubePromptPlaceholder: "Edit the default prompt if needed…",
    ...
    youtubeGenerateOutline: "Generate outline",
    youtubeCancel: "Cancel generation",
    youtubeCanceled: "Generation canceled",
    youtubeStillGenerating: "Still generating…",
    youtubeStreamDisconnectedPolling: "Connection closed — waiting for the result in the background…",
    youtubeStreamPollTimeout: "Generation is taking longer than expected. Check My History shortly.",
    ...
    queueDocument: "Document Mode",
    queueNovel: "Novel Guide",
    queueOutline: "Outline",
    queueCardHint: "Distills core ideas into theme cards for quick review.",
    queueDocumentHint: "Builds a full presentation deck with slides and visuals.",
    queueNovelHint: "Produces a Markdown reading guide from uploaded books.",
    queueOutlineHint: "Organizes YouTube transcript into a Markdown outline with timestamp jumps.",
    queueHint:
      "Card mode distills core ideas into theme cards; Document mode builds a full deck; Novel Guide mode produces a Markdown reading guide from uploaded books; YouTube Outline mode organizes transcript sections.",
    creditsInsufficient: "Not enough credits to generate a deck",
    invalidQueueError: "Your client is outdated. Please refresh the page and try again.",
    ...
    loadingOutline: "Organizing video outline…",
    loadOutlineFailed: "Could not load the video outline. Check your network and try again.",
    outlineResultTitle: "Video transcript outline",
    outlineResultBadge: "Video Outline",
    outlineResultClose: "Close",
    outlineResultReady: "Video outline is ready",
    outlineResultEmpty: "Generation finished, but no outline content was found",
    outlineResultSections: "{n} sections",
    ...
    novelAnnotateHighlight: "Highlight",
    novelAnnotateNote: "Add note",
    novelAnnotateNotePlaceholder: "Write your thoughts on this passage…",
    novelAnnotateNoteEmpty: "(No note yet)",
    novelAnnotateEdit: "Edit note",
    novelAnnotateDelete: "Delete highlight",
    novelAnnotateSave: "Save",
    novelAnnotateCancel: "Cancel",
    novelAnnotateSaved: "Saved",
    novelAnnotateSaveFailed: "Save failed, please try again",
    ...
    assets: {
      ...
      noUploaded: "No uploaded files yet",
      noGeneratedAll: "No generated content yet. Upload a PDF or enter a prompt to get started.",
      noGeneratedPpt: "No presentations yet. Complete a document analysis first.",
      noGeneratedNovel: "No novel guides yet",
      noGeneratedImage: "No generated images yet",
  ...
  translate: {
    ...
    loadingWeb: "Fetching page…",
    webFetchFailed: "Failed to fetch the page. Make sure it is publicly accessible, or try again later.",
    webFetchInvalidUrl: "Invalid URL. Please check the link and try again.",
    webFetchUrlNotAllowed: "This address is not allowed (internal or restricted URL).",
    webFetchPageTooLarge: "Page is too large (over 8MB). Try a smaller page.",
    webFetchUnavailable: "The target site is temporarily unreachable. Please try again later.",
    webFetchTimeout: "Page fetch timed out. Please try again later.",
    translating: "Translating…",
    progress: "Translating {done}/{total}",
    loginRequired: "Sign in to translate",
    loginRequiredHint: "Immersive translation requires an account. After you sign in, we'll continue translating this page.",
    login: "Sign in",
    error: "Translation failed",
    retry: "Retry",
    page: "Page number",
    noFile: "Nothing to translate yet. Please go back and pick one.",
  },
  reader: {
    back: "Back",
    ...
    prev: "Previous",
    next: "Next",
    noFile: "Nothing to read yet. Please go back and pick a file.",
    mobiUnsupportedTitle: "MOBI can't be read online yet",
    mobiUnsupportedDesc: "MOBI is a Kindle-proprietary format that browsers can't render directly. Convert the file to EPUB or PDF and upload it again to read online.",
    ...
    xlsxTotalRows: "{total} rows total",
    xlsxSortClick: "Click to sort",
    xlsxSortAsc: "Ascending (A→Z, small→large)",
    xlsxSortDesc: "Descending (Z→A, large→small)",
    xlsxScrollMore: "· scroll for more",
    xlsxLoadingMore: "Loading more rows…",
    hubTitle: "Read online",
    hubSubtitle: "Continue AI guides or upload a local ebook to read in the browser.",
    localTitle: "Upload a local ebook",
    localHint: "PDF, EPUB, MOBI, and XLSX files open directly in your browser.",
    localPickFile: "Click or drag a file here",
    localFormats: "PDF · EPUB · MOBI · XLSX",
    localStart: "Start reading",
    backToHub: "Back to reading hub",
    continueTitle: "Continue reading",
    continueHint: "Tap Read to open AI guides and decks you've already started.",
    continueLoginHint: "Sign in to see and continue books you've already started.",
    continueLogin: "Sign in to continue",
    continueEmpty: "No books in progress yet. Open one from Explore to get started.",
    ...
    saveBookWorkspace: "Send to workspace",
    saveBookWorkspaceTitle: "Send book to personal workspace",
    saveBookWorkspaceSuccess: "Sent to workspace. Continue in the Read tab.",
    saveBookWorkspaceLoginRequired: "Please log in before sending to workspace",
  },
  community: {
    ...
    stats: {
      ...
      finishedSub: "{count} finished",
      slides: "Slides",
      slidesValue: "{count} slides",
      slidesSub: "Interactive summary",
      wordCount: "Length",
      publishedAt: "Published {date}",
      copyright: "Copyright",
      copyrightPublisher: "Publisher license",
      copyrightCommunity: "Community summary",
      originalAuthor: "Original author",
    },
    rating: {
      required: "Please pick a rating (Recommend / Average / Poor)",
      label: "Rating",
    },
    like: {
      click: "Like",
    ...
    recommend: {
      ...
      rave: "Highly recommended",
      worth: "Worth reading",
      mixed: "Mixed reviews",
      barRecommend: "Recommend",
      barAverage: "Average",
      barPoor: "Poor",
      filterAll: "All",
  ...
  agent: {
    ...
    pptShareExportVideo: "Export video (MP4)",
    pptVideoExportTitle: "Export video",
    pptVideoExportHint: "Pick an orientation to render every slide with its narration audio into an MP4.",
    pptVideoExportLandscape: "Landscape",
    pptVideoExportPortrait: "Portrait",
    pptVideoExportStart: "Start",
    pptVideoExportProcessing: "Generating video…",
    pptVideoExportCapturing: "Capturing slides…",
    pptVideoExportLoadingEngine: "Loading video engine…",
    pptVideoExportRendering: "Rendering each slide…",
    pptVideoExportConcat: "Joining clips…",
    pptVideoExportMuxing: "Muxing audio & video…",
    pptVideoExportFinalizing: "Finalizing video…",
    pptVideoExportDownload: "Download",
    pptVideoExportAgain: "Regenerate",
    pptVideoExportFailed: "Video export failed",
