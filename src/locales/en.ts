...
export default {
  ...
  landing: {
    ...
    translateTitle: "Immersive PDF translation",
    translateHint: "Upload a PDF and see translations overlaid under the original text, page by page. Only visible pages are translated and cached locally.",
