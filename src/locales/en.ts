...
export default {
  ...
  pricing: {
    ...
    howHint: "Generating a deck from a book or document deducts credits by queue. Sign up includes trial credits.",
    usageSlow: "Slow queue · Book / document → deck",
    usageSlowCredits: "30 credits / run",
    usageSlowDesc: "Queued generation at a lower price—great when you're not in a hurry.",
    usageFast: "Fast queue · Book / document → deck",
    usageFastCredits: "60 credits / run",
    usageFastDesc: "Priority processing for quicker results when you need it now.",
