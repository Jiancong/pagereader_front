...
export default {
  ...
  landing: {
    ...
    uploadFormats: "PDF, Word, TXT, Markdown, EPUB",
    ...
    uploadHint: "PDF, Word, TXT, EPUB, etc.—AI extracts key content for your deck",
    pickFile: "Choose file",
    uploadFormatsShort: "PDF, Word, TXT, Markdown, EPUB",
  ...
  workspace: {
    ...
    uploadHintCard:
      "PDF, Word, TXT, EPUB, etc.—AI distills the book's core ideas into easy-to-review knowledge cards",
    uploadHintNovel:
      "PDF, Word, TXT, EPUB, etc.—AI generates a Markdown guide with summary, characters, chapter notes, and Q&A",
    pickFile: "Choose file",
    uploadFormatsShort: "PDF, Word, TXT, Markdown, EPUB",
