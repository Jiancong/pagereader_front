...
export default {
  ...
  pricing: {
    ...
    packsTitle: "套餐方案",
    packsHint: "体验包与专业包按月订阅，获得更多积分与云空间（免费版不在此页展示，注册即可使用）。",
    starterName: "体验包",
    starterBadge: "入门",
    starterPrice: "$9.9 / 月",
    starterCredits: "每月 900 积分",
    starterEquiv: "约 10 次慢速，或 5 次快速 PPT",
    starterDaily: "每日 60 点免费积分（慢速 PPT 优先）",
    ...
    proDaily: "每日 90 点免费积分（慢速 PPT 优先）",
    proF1: "重度读书 / 备课 / 研报场景",
    proF2: "更省单价，适合连续多本书",
    proF3: "优先邮件支持",
    proCta: "注册并订阅",
    ...
    contactCta: "联系商务",
    footnote: "PayPal 为自动续订订阅；微信为一次性月付，到期需重新购买。扣费规则以工作区内积分与队列为准。",
    loadingPlans: "正在加载套餐…",
