...
export default {
  ...
  pricing: {
    ...
    starterDaily: "每日 60 点免费积分（可用于卡片生成）",
    ...
    dailyFreeNote: "每日 30 免费积分 · 可用于卡片生成",
    wechatPay: "微信支付（扫码）",
    ...
    faq: {
      ...
      credits: {
        ...
        agentP2: "单次扣费取决于：",
        liDocument:
          "<strong>文档生成 / 小说导读：</strong>每次 {document} 积分；仅扣套餐积分。",
        liCard: "<strong>卡片型生成：</strong>每次 {card} 积分；优先消耗每日 {daily} 免费积分，不足再扣套餐积分。",
        liDaily: "<strong>每日免费积分：</strong>每天 {daily} 积分，仅可用于卡片生成，当日未用完不结转。",
      ...
      rollover: {
        ...
        dailyTitle: "每日免费积分",
        dailyP: "每日 {daily} 积分仅可用于卡片生成，<strong>不累计、不结转</strong>，次日重置。",
        topupTitle: "加购积分",
